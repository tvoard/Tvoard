...
// const val ACTION_BACKSPACE = 8; not used.
...
// Korean
const val HANGUL_START = 0xAC00
const val HANGUL_END = 0xD7A3
const val HANGUL_JAMO_START = 0x3131
const val HANGUL_MO_START = 0x314F
const val HANGUL_JAMO_END = 0x3163